...
function Hero2() {
  return (
    <section
      ...
      style={{
        backgroundImage:
          "url('https://talaghesti.com/assets/images/home-5/hero/bg-image.jpg')",
      }}
    >
              ...
              <div className="row g-4 align-items-center">
                <div className="col-lg-6">
                  <div className="hero-content">
                    ...
                    <h1>دوشنبه قرطی</h1>
                    <p>
                      طلای اقساطی، با کمترین پیش قسط! بدون چک و ضامن 📌 تسهیلات
                      ویژه جهت بازنشستگان محترم
                    </p>
                    <p>⏳ موجودی محدود – فرصت رو از دست نده!</p>
              ...
              <div className="row g-4 align-items-center">
                <div className="col-lg-6">
                  <div className="hero-content">
                    ...
                    <h1>فروش ویژه طلاهای تخفیفی</h1>
                    <p>طلای سرمایه‌ای، انتخاب هوشمندانه!</p>
                    <p>عرضه‌ی محدود با کمترین حاشیه سود</p>
                    <p>📌 فقط فروش نقدی – بدون اقساط</p>
                    <p>⏳ موجودی محدود – فرصت رو از دست نده!</p>
